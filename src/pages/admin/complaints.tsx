    ...
    <Layout>
      <div className="min-h-screen bg-gray-50 p-6">
        ...
        <div className="mb-8">
          ...
          <p className="text-gray-600">Kelola dan pantau semua laporan aduan dalam sistem</p>
        </div>
          ...
          <div className="p-6 border-b border-gray-200">
            ...
            <div className="mt-4 flex justify-between items-center">
              ...
              <span className="text-sm text-gray-500">
                Menampilkan {complaints.length} aduan
              </span>
            </div>
          </div>
        </div>
                    ...
                    <td className="px-6 py-4 whitespace-nowrap text-sm font-medium">
                      <div className="flex space-x-2">
                        ...
                        {complaint.attachment && (
                          <button 
                            onClick={() => setSelectedImage({ url: complaint.attachment!, title: complaint.title })}
            ...
            <div className="relative max-w-4xl max-h-full">
              ...
              <div className="bg-white rounded-lg p-4">
                <h3 className="text-lg font-medium text-gray-900 mb-4">
                  Bukti Lampiran: {selectedImage.title}
                </h3>
                <img
                  src={selectedImage.url}
                  alt={`Bukti lampiran: ${selectedImage.title}`}
...
export default withAuth(AdminComplaints, ['admin']);
