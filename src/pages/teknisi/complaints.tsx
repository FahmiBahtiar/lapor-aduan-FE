...
const TeknisiComplaints = () => {
  ...
  const fetchComplaints = async () => {
    try {
      setLoading(true);
      // Use regular getComplaints endpoint, not getAllComplaints (admin only)
            ...
            <div className="p-5">
              <div className="flex items-center">
                ...
                <div className="ml-5 w-0 flex-1">
                  <dl>
                    <dt className="text-sm font-medium text-gray-500 truncate">Tersedia Diambil</dt>
...
// Teknisi Complaint Card Component
interface TeknisiComplaintCardProps {
  complaint: Complaint;
...
const TeknisiComplaintCard = ({ complaint, onTake, onProcess, onFinish, currentUserId }: TeknisiComplaintCardProps) => {
        ...
        <div className="flex items-start justify-between">
          <div className="flex-1">
            ...
            {complaint.attachment && (
              <div className="mb-4">
                <h4 className="text-sm font-medium text-gray-700 mb-2">Gambar dari Pelapor:</h4>
                <ImageViewer
...
export default withAuth(TeknisiComplaints, ['teknisi']);
